...
class Student:
    def __init__(self,root):
        ...
        title_lbl=Label(lbl_bg,text="STUDENT MANAGEMENT SYSTEM",font=("times new roman",35,"bold"),bg="white",fg="darkgreen")
        title_lbl.place(x=0,y=0,width=1550,height=45)
        
        main_frame = Frame(lbl_bg,bd=2)
        main_frame.place(x=5,y=55,width=1520,height=720)
        ...
        img1=img1.resize((720,200),Image.Resampling.LANCZOS)
        self.photoimg1=ImageTk.PhotoImage(img1)
        
        l_lbl=Label(left_frame,image=self.photoimg1)
        ...
        current_course.place(x=5,y=205,width=715,height=125)
        ...
        dep_combo["values"]=("Select Department","Computer Science and Engineering","Electronics and Communication Engineering","Civil Engineering","Mechanical Enginnering","Chemical Engineering")
        dep_combo.current(0)
        ...
        course_combo["values"]=("Select Course","CSE","CSE AIML","CSE DS","ECE","CHEMICAL","MECHANICAL","CIVIL")
        ...
        year_combo["values"]=("Select Year","2022-26","2023-27","2024-28","2025-29")
        ...
        class_student.place(x=5,y=330,width=715,height=330)
        
        #student id
        studentId_label=Label(class_student,text="Student Id:",font=("times new roman",12,"bold"),bg="white")
        studentId_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)
        
        studentId_entry=ttk.Entry(class_student,textvariable=self.var_std_id,width=20,font=("times new roman",12))
        ...
        studentName_entry=ttk.Entry(class_student,textvariable=self.var_std_name,width=20,font=("times new roman",12))
        ...
        roll_no_entry=ttk.Entry(class_student,textvariable=self.var_roll,width=20,font=("times new roman",12))
        ...
        dob_entry=ttk.Entry(class_student,textvariable=self.var_dob,width=20,font=("times new roman",12))
        ...
        email_entry=ttk.Entry(class_student,textvariable=self.var_email,width=20,font=("times new roman",12))
        ...
        phone_entry=ttk.Entry(class_student,textvariable=self.var_phone,width=20,font=("times new roman",12))
        ...
        address_entry=ttk.Entry(class_student,textvariable=self.var_address,width=20,font=("times new roman",12))
        ...
        teacher_entry=ttk.Entry(class_student,textvariable=self.var_teacher,width=20,font=("times new roman",12))
        ...
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=18,font=("times new roman",12,"bold"),bg="#144911",fg="white")
        save_btn.grid(row=0,column=0)
        
        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=18,font=("times new roman",12,"bold"),bg="#144911",fg="white")
        update_btn.grid(row=0,column=1)
        
        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width=18,font=("times new roman",12,"bold"),bg="#144911",fg="white")
        delete_btn.grid(row=0,column=2)
        
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=18,font=("times new roman",12,"bold"),bg="#144911",fg="white")
        reset_btn.grid(row=0,column=3)
        
        btn_frame1 = Frame(class_student,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=5,y=235,width=690,height=35)
        
        take_photo_btn=Button(btn_frame1,command=self.generate_dataset,text="Take Photo Sample",width=37,font=("times new roman",12,"bold"),bg="#144911",fg="white")
        take_photo_btn.grid(row=0,column=0)
        
        update_photo_btn=Button(btn_frame1,text="Update Photo Sample",width=37,font=("times new roman",12,"bold"),bg="#144911",fg="white")
        update_photo_btn.grid(row=0,column=1)
        
        #right label
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Student Details",font=("times new roman",12,"bold"))
        right_frame.place(x=760,y=10,width=730,height=700)
        ...
        r_lbl=Label(right_frame,image=self.photoimg2)
        r_lbl.place(x=5,y=0,width=715,height=200)
        
        #search system
        search = LabelFrame(right_frame,bd=2,bg="white",relief=RIDGE,text="Search System",font=("times new roman",12,"bold"))
        search.place(x=5,y=205,width=715,height=70)
        
        search_bar_label=Label(search,text="Search By",font=("times new roman",14,"bold"),bg="#144911",fg="white")
        search_bar_label.grid(row=0,column=0,padx=10,pady=5,sticky=W)
        ...
        search_entry=ttk.Entry(search,width=15,font=("times new roman",12))
        search_entry.grid(row=0,column=2,padx=10,pady=5,sticky=W)
        
        search_btn=Button(search,text="Search",width=13,font=("times new roman",12,"bold"),bg="#144911",fg="white")
        search_btn.grid(row=0,column=3,padx=4)
        
        showAll_btn=Button(search,text="Show All",width=13,font=("times new roman",12,"bold"),bg="#144911",fg="white")
        showAll_btn.grid(row=0,column=4)
        
        #table frame
        table = Frame(right_frame,bd=2,bg="white",relief=RIDGE)
        table.place(x=5,y=290,width=715,height=350)
        
        scroll_x=ttk.Scrollbar(table,orient=HORIZONTAL)
        scroll_y=ttk.Scrollbar(table,orient=VERTICAL)
        
        self.student_table=ttk.Treeview(table,column=("dep","course","year","sem","id","name","div","roll","gender","dob","email","phone","address","teacher","photo"),xscrollcommand=scroll_x.set, yscrollcommand=scroll_y.set)
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                conn=mysql.connector.connect(host="localhost",username="root",password="Sriya@2004",
